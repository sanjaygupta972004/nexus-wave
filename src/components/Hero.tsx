...
export default function Hero() {
  return (
    <div className=' bg-[linear-gradient(to_bottom,#000000,#200D42,#4F21A1,#A46EDB)] '>
        <div className=' text-white flex gap-7 items-center justify-center flex-col px-4 sm:px-1 pt-16 w-99 h-154 sm;w-210 sm:h-182'>
           ...
           <button className=" bg-white text-gray-700 rounded-md p-1 hover:bg-opacity-90  mb-12 ">
                Get for free
           </button>
        </div>
    </div>
